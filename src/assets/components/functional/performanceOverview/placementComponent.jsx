...
const KeywordsComponent = () => {
    ...
    const getKeywordsData = async () => {
        ...
        try {
            const url = `https://react-api-script.onrender.com/continental/placement?start_date=${startDate}&end_date=${endDate}&platform=${operator}`;
    ...
    const handleKeywordClick = async (keywordName, campaignId) => {
        try {
            ...
            const response = await fetch(`https://react-api-script.onrender.com/continental/keyword_graph?start_date=${formatDate(startDate)}&end_date=${formatDate(endDate)}&platform=${operator}&campaign_id=${campaignId}&keyword=${keywordName}`, {
                method: "GET",
                headers: {
                    "Content-Type": "application/json",
                    Authorization: `Bearer ${token}`,
    ...
    const confirmStatusChange = async () => {
        ...
        try {
            ...
            const response = await fetch(`https://react-api-script.onrender.com/continental/toggle_keyword_or_target_state?${params.toString()}`, {
                method: "PUT",
                headers: {
                    "Authorization": `Bearer ${token}`,
                    "Content-Type": "application/json"
